...
openSettings=function(){
  ...
  b.innerHTML=
    ...
    "<div class=\"rw\"><div class=\"fd\"><label>\u670D\u52A1\u5546\uFF08\u9009\u4E00\u5BB6\u81EA\u52A8\u586B\u597D\u5730\u5740\u548C\u793A\u4F8B\u6A21\u578B\uFF09</label><select id=\"s-prov\" onchange=\"sProvPreset(this.value)\"><option value=\"\">（请选择服务商）</option>"+_sProvOptions()+"</select></div><div class=\"fd\"><label>Key\uFF08API \u5BC6\u94A5\uFF0C\u76F8\u5F53\u4E8E\u5BC6\u7801\u00B7\u52FF\u5916\u6CC4\uFF09</label><input type=\"password\" id=\"s-key\" value=\""+(P.ai.key||"")+"\" placeholder=\"\u5728\u670D\u52A1\u5546\u5B98\u7F51\u300CAPI Keys\u300D\u9875\u521B\u5EFA\uFF0C\u591A\u4EE5 sk- \u5F00\u5934\"></div></div>"+
    ...
    (function(){
      ...
      return "<div class=\"settings-section\" style=\"border-left:3px solid var(--indigo-400,#4a6fa5);\"><h4 style=\"color:#92acd0;\">\u6B21\u8981 API\u00B7\u5FEB\u6A21\u578B\u8DEF\u7531" + badge + "</h4>"+
        ...
        "<div class=\"rw\"><div class=\"fd\"><label>\u670D\u52A1\u5546\uFF08\u9009\u4E00\u5BB6\u81EA\u52A8\u586B\u5730\u5740\u548C\u793A\u4F8B\u6A21\u578B\uFF09</label><select id=\"s-sec-prov\" onchange=\"sProvPreset(this.value,'sec')\"><option value=\"\">（请选择服务商）</option>"+_sProvOptions()+"</select></div><div class=\"fd\"><label>Key</label><input type=\"password\" id=\"s-sec-key\" value=\""+(sec.key||"")+"\" placeholder=\"\u7559\u7A7A\u5219\u56DE\u9000\u4E3B API\"></div></div>"+
