...
openSettings=function(){
  ...
  b.innerHTML=
    ...
    "<div class=\"rw\"><div class=\"fd\"><label>\u5730\u5740\uFF08Base URL\u00B7\u670D\u52A1\u5546\u7684\u63A5\u53E3\u7F51\u5740\uFF09</label><input id=\"s-url\" value=\""+(P.ai.url||"")+"\" placeholder=\"\u5982 https://api.deepseek.com/v1\uFF0C\u4E00\u822C\u4EE5 /v1 \u7ED3\u5C3E\"></div><div class=\"fd\"><label>Model_ID</label><input id=\"s-model\" value=\""+(P.ai.model||"")+"\" placeholder=\"ep-......\u4E0D\u662FLLM\u540D\u79F0\"></div></div>"+
    ...
    "<div class=\"rw\"><div class=\"fd\"><label style=\"font-size:0.72rem;\">Model_ID</label><input id=\"s-img-model\" value=\""+(function(){try{return JSON.parse(localStorage.getItem('tm_api_image')||'{}').model||'dall-e-3';}catch(e){return 'dall-e-3';}})()+"\" placeholder=\"ep-......\u4E0D\u662FLLM\u540D\u79F0\" style=\"font-size:0.8rem;\"></div></div>"+
