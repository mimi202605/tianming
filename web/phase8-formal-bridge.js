...
(function(){
  ...
  function installStyles(){
    ...
    st.textContent = [
      ...
      'body.tm-phase8-formal .tmf-faction-label rect.tmf-seal{display:block!important;fill:rgba(139,46,37,.10);stroke:rgba(176,52,40,.52);stroke-width:1.1;paint-order:fill;vector-effect:non-scaling-stroke;}body.tm-phase8-formal .tmf-faction-label .tmf-seal-corner{fill:none;stroke:rgba(212,68,46,.72);stroke-width:1.5;stroke-linecap:square;vector-effect:non-scaling-stroke;}body.tm-phase8-formal .tmf-faction-label:hover rect.tmf-seal{fill:rgba(159,52,42,.17);stroke:rgba(216,86,58,.82);}body.tm-phase8-formal .tmf-faction-label.tmf-vert text.main{writing-mode:vertical-rl;text-orientation:upright;letter-spacing:.06em;}body.tm-phase8-formal .ming-label text{font-weight:600;fill:#e9d3a2!important;text-shadow:0 .5px 0 rgba(0,0,0,.35);}body.tm-phase8-formal .ming-label rect{fill:rgba(24,17,9,.5);stroke:rgba(206,178,108,.3);}',
