...
var scT = read('scenarios/tianqi7-1627.js');
ok(/"historicalFallYear": 1644/.test(scT) && /"historicalFallMonth": 3/.test(scT), '官方剧本·天启七年带明亡1644年3月');
var scS = read('scenarios/shaosong-jianyan-1127.js');
ok(/"historicalFallYear": 1279/.test(scS) && /崖山海战/.test(scS), '官方剧本·绍宋带宋亡1279崖山');
