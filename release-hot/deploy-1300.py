#!/usr/bin/env python3
"""Server-side deploy for Tianming 1.3.0.0 — runs ON the server (python3), pulls everything
...
Run on the server (1Panel VNC / web terminal):
  curl -sL https://github.com/misfit-user/tianming/releases/download/hot-1.3.0.0/deploy-1292.py -o /tmp/deploy-1292.py
