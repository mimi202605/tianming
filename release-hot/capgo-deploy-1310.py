#!/usr/bin/env python3
"""安卓 Capgo 落位 1.3.1.0 — 服务器跑·从 GitHub Release 拉 bundle + latest.json 放 /tianming/capgo/
  curl -sL https://github.com/misfit-user/tianming/releases/download/hot-1.3.1.0/capgo-deploy-1310.py -o /tmp/c.py
  python3 /tmp/c.py
"""
import urllib.request, os, time, json, shutil
TAG, VER = "hot-1.3.1.0", "1.3.1.0"
...
def main():
    ...
    print(f"[capgo {VER}] downloading bundle (~469MB) from GitHub...", flush=True)
    ...
    print("=== DONE capgo 1.3.1.0 PUBLISHED ===")
