#!/usr/bin/env python3
"""Server-side deploy for Tianming 1.2.9.2 — runs ON the server (python3), pulls everything
from GitHub over HTTP (no SSH from the dev side needed). Places the 11MB delta into the
...
Run on the server (1Panel VNC / web terminal):
  curl -sL https://github.com/misfit-user/tianming/releases/download/hot-1.2.9.2/deploy-1292.py -o /tmp/deploy-1292.py
  python3 /tmp/deploy-1292.py
"""
