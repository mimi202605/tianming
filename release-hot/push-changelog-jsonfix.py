"""GitHub push·fix changelog.json JSON parse errors (unescaped quotes in recent entries)"""
...
BATCH_MSG = "1.2.7.6.1 fix changelog.json JSON parse errors (unescaped quote chars in recent entries)"
BODY = (
    "Fix JSON parse errors in changelog.json caused by unescaped inline double quotes "
    "in 1.2.7.4 / 1.2.7.5 / 1.2.7.6 entries. Standalone server already re-uploaded.\n\n"
    "Co-Authored-By: Claude Opus 4.7 (1M context) <noreply@anthropic.com>"
)

FILES = [("changelog.json", WEB / "changelog.json")]
...
tmp = Path("C:/Users/37814/Desktop/push-jsonfix-payload.json")
