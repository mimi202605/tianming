...
REAL = "/opt/1panel/apps/openresty/openresty/www/sites/api.themisfitserspeople.top/index/tianming/hot"
VER = "1.2.6.4"
...
if not pw: print("ERROR: TIANMING_SSH_PASS not set", file=sys.stderr); sys.exit(2)
