"""GitHub Path B push for 1.2.4.3·single batch·4 files·~< 1 MB total"""
...
BATCH_MSG = "1.2.4.3 桌面端卡顿 + 输入框光标缺失修 (B+C 两轨)"
FILES = [
    ("changelog.json", WEB / "changelog.json"),
    ("index.html", WEB / "index.html"),
    ("tm-electron.js", WEB / "tm-electron.js"),
...
payload = {
    ...
    "variables": {"input": {
        ...
        "message": {"headline": BATCH_MSG, "body": "Co-Authored-By: Claude Opus 4.7 (1M context) <noreply@anthropic.com>"},
        "fileChanges": {"additions": additions},
        "expectedHeadOid": head_sha
    }}
}
tmp = Path("C:/Users/37814/Desktop/push-1243-payload.json")
